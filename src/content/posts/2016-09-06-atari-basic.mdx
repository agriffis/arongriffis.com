...
import atari from '../../images/atari-800.png'
import manual from '../../images/atari-800-basic-manual.jpg'

When I was a kid, my family had an
[Atari 800](https://en.wikipedia.org/wiki/Atari_8-bit_family) computer.

<Media>
  <a href="https://commons.wikimedia.org/wiki/File%3AAtari_800.jpg" title="Image by Bilby [CC BY 3.0], via Wikimedia Commons">
    <Image src={atari} alt="Atari 800 computer" />
  </a>
</Media>
...
<Media>
  <a href="http://www.vintagecomputing.com/index.php/archives/815/retro-scan-of-the-week-father-and-son-at-the-atari" title="Image by Vintage Computing and Gaming, used by permission">
    <Image src={manual} alt="Atari 800 BASIC reference manual" />
  </a>
</Media>
