...
[Zprint](https://github.com/kkinnear/zprint) is a Clojure formatter. By default,
it fully reformats a top-level form, replacing all the
...
And then configure [LazyVim](https://www.lazyvim.org/) to use zprint for
Clojure:
...
means that the new mappings should work with a following motion, and they should
