...
**UPDATE**: [Duck-typing to the rescue](/2010-08-29-python-httplib-debug)
...
> Originally posted on the [n01se blog](https://web.archive.org/web/20200803113306/http://blog.n01se.net/blog-n01se-net-p-213.html)
