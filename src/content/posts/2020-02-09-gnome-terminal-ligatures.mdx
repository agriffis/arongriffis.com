...
import jetbrainsGnomeTermBad from '../../images/gnome-terminal-jetbrains-mono-ligatures.png'
import jetbrainsGnomeTermGood from '../../images/gnome-terminal-jetbrains-mono-fixed.png'
...
<Media wide>
  <Image src={jetbrainsGnomeTermBad} alt="GNOME Terminal making a mess of JetBrains Mono ligatures" />
</Media>
...
<Media wide>
  <Image src={jetbrainsGnomeTermGood} alt="GNOME Terminal displaying JetBrains Mono nicely without ligatures" />
</Media>
