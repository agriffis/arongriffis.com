...
import neovimNightlyPackages from '../../images/neovim-nightly-packages.png'
...
<Media>
  <a href="https://copr.fedorainfracloud.org/coprs/agriffis/neovim-nightly/packages/" title="Fedora Copr agriffis/neovim-nightly packages">
    <Image src={neovimNightlyPackages} alt="foo" />
  </a>
</Media>
...
<p class="note">See also: [Neovim nightlies revisited](/2019-04-15-neovim-nightlies-revisited).</p>
